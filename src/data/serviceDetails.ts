...
export const serviceDetails: ServiceDetail[] = [
  {
    ...
    longDescription: "Our data migration services ensure your business-critical data moves safely and efficiently from legacy systems to modern platforms. With zero downtime strategies and comprehensive validation, we handle migrations of any size and complexity.",
    features: [
      ...
      "Rollback planning and support",
    ],
    benefits: [
      "Minimize business disruption during migration",
      "Ensure data accuracy and completeness",
      "Reduce migration timeline by 40%",
      "Comprehensive documentation and training",
    ],
    processSteps: [
      {
        title: "Assessment",
        description: "We analyze your current system, data structure, and business requirements to create a detailed migration plan.",
      },
      {
        title: "Planning",
        description: "Develop a comprehensive migration strategy with timelines, resource allocation, and risk mitigation.",
      },
      {
        title: "Testing",
        description: "Perform thorough testing in a staging environment to validate data integrity and system functionality.",
      },
      {
        title: "Execution",
        description: "Execute the migration with minimal disruption, following our proven zero-downtime methodology.",
      },
      {
        title: "Validation",
        description: "Verify all data has been migrated correctly and perform comprehensive quality checks.",
      },
    ],
    pricing: [
      {
