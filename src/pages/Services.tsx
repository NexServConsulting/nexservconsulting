...
import { Database, Cloud, RefreshCw, TrendingUp, FileSpreadsheet, Server, ArrowRight, Globe, Wrench, CloudLightning } from "lucide-react";
...
const Services = () => {
  const services = [
    ...
    // },
    {
      ...
      features: ["Responsive design", "Full-stack development", "Modern responsive UI", "Database-driven functionality"],
    },
  ];
