  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-5xl mx-auto text-center animate-fade-in">
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold mb-8 text-white leading-tight">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-lg">
                We’ve been in the trenches with messy databases, slow queries, broken ETL pipelines, and painful Excel or MS Access
      ...
      >
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Comprehensive data and web solutions tailored to meet your specific business needs.
            </p>
          </div>
      ...
      >
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 text-foreground">Blog</h2>
